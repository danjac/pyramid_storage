...
project = 'Pyramid storage library'
...
#html_theme = 'pyramid'
#html_theme_options = dict(github_url='http://github.com/Pylons/pyramid_storage')
...
html_title = 'pyramid_storage v%s' % release
